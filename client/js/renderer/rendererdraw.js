// Mixin extracted from renderer.js: All PIXI drawing: sprites/tiles/items/entities, name/health/harvest bars, speech bubbles, debug/combat HUD text, the letterbox cutscene bars.
...
/* global Types, ItemTypes, Utils, log, G_TILESIZE */
...
export function installRendererDraw(proto) {
    ...
    proto.drawSpriteHUD = function(sprite, imgX, imgY, imgW, imgH, scrX, scrY, scrW, scrH, flipX, flipY)
    {
      const s = 2;
