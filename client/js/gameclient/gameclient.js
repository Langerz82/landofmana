...
export default class GameClient {
    constructor() {
        ...
        this.onMessage = function (data) {
            ...
            if (method === '2') {
                ...
                try {
                    const message = pako.inflate(buffer, {
                        gzip: true,
                        to: 'string'
                    });
    ...
    setHandlers() {
        ...
        this.handlers[Types.Messages.WC_CHANGEPOINTS] =
        ...
        this.handlers[Types.Messages.WC_ITEMLEVELUP] =
            this.itemlevelup_callback;
        ...
        this.handlers[Types.Messages.WC_ACHIEVEMENT] =
            this.achievement_callback;
        this.handlers[Types.Messages.WC_SKILLEFFECTS] =
            this.skilleffects_callback;
        ...
        this.handlers[Types.Messages.WC_TELEPORT_MAP] =
            this.teleportmap_callback;
        ...
        this.handlers[Types.Messages.WC_SET_ANIMATION] =
    ...
    receiveSpawn(data) {
        ...
        if (
            type === Types.EntityTypes.ITEM ||
            type === Types.EntityTypes.ITEMLOOT
        ) {
            const item = EntityFactory.createEntity(
                type,
                kind,
                id,
                mapIndex,
