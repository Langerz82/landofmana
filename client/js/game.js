...
import AppearanceDialog from './dialog/appearance/appearancedialog.js';
...
import ShortcutHandler from './shortcut/shortcuthandler.js';
...
import StoreDialog from './dialog/store/storedialog.js';
import AuctionDialog from './dialog/auction/auctiondialog.js';
import CraftDialog from './dialog/craft/craftdialog.js';
import BankDialog from './dialog/bank/bankdialog.js';
...
import { installGameInteractionTarget } from './game/gameinteractiontarget.js';
import { installGameInteractionCombat } from './game/gameinteractioncombat.js';
import { installGameInteractionInput } from './game/gameinteractioninput.js';
...
export default class Game {
    ...
    gametick() {
        ...
        if (self.gamepad) this.gamepad.interval();
    ...
    removeObsoleteEntities() {
        ...
        if (nb > 0) {
            ...
            if (delist.length > 0) self.client.sendWho(delist);
        }
    }
}
...
installGameInteractionTarget(Game.prototype);
installGameInteractionCombat(Game.prototype);
installGameInteractionInput(Game.prototype);
